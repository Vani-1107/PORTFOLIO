            ...
            <div className='w-10/12 mx-auto flex gap-x-20 pt-16 relative'>
                ...
                <div className='shadow-sm shadow-purple p-7 rounded-lg flex flex-col w-[30vw]'>
                    ...
                    <form className='flex flex-col space-y-5'>
                        <input type='text' required placeholder='Full Name' className='px-2 py-1 border border-purple rounded-lg bg-[#6c6b6b32]'></input>
                        <input type='email' required placeholder='Email address' className='px-2 py-1 border border-purple rounded-lg bg-[#6c6b6b32]'></input>
                        <input type='text' required placeholder='Subject' className='px-2 py-1 border border-purple rounded-lg bg-[#6c6b6b32]'></input>
                        <input type='textbox' required className='px-2 py-1 border border-purple rounded-lg bg-[#6c6b6b32]' placeholder='Your Message'></input>
                        
                    </form>
                    <button className='flex space-x-2 items-center w-fit px-4 py-2 rounded-lg bg-purple text-black mt-8'>
                        <div>Submit</div> 
                        <span><FiSend/></span>
                    </button>
                </div>
                ...
                <div className='flex flex-col space-y-6 relative top-10  font-Poppins'>
                    <div className='shadow-md shadow-purple p-4 w-72'>
                        <a href='https://www.linkedin.com/in/vani03/' className='flex flex-row items-center space-x-5 '>
                    ...
                    <div className='shadow-md shadow-purple p-4'>
                        <a href='https://www.instagram.com/__vanigupta__/' className='flex flex-row items-center space-x-5 '>
                    ...
                    <div className='shadow-md shadow-purple p-4'>
                        <a href='https://github.com/Vani-1107' className='flex flex-row items-center space-x-5 '>
