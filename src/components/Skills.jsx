...
function Skills({isDark}){
    ...
    return(
        <div className={`footer_bg${isDark} w-full relative pt-14 pb-20 font-Poppins`} id='skills'>
                {/* <NavLink to='/about'>
                    <div className='opacity-0 sm:opacity-100 absolute flex items-center justify-center top-[50%] left-6'>
                        <div className='shiftSkills flex justify-center items-center'>
                ...
                <div className='flex w-10/12 mx-auto space-x-8 mt-20 justify-between'>
                    {/* languages */}
                    ...
                    {/* libraries */}
                    <div className='flex flex-col w-[28%] relative'>
